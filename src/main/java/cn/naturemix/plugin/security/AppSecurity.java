 ...
 * @version 1.0.0
 */
public class AppSecurity  implements NaturemixSecurity{
    ...
    public Set<String> getRoleNameSet(String username) {
        String sql = "SELECT r.role_name FROM user u,user_role ru,role r WHERE u.id = ur.user_id AND r.id = ur.role_id AND u.username = ?";
